...
<div class="settings">
    <div class="container-fluid">
        ...
        <form class="form" action="" method="post">
            ...
            <div class="form-group">
                <label>Motto</label>
                <input type="text" name="app_motto" value="{{ $set->app_motto }}" class="form-control input-lg input-white">
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="phone3" value="{{ $set->phone3 }}" class="form-control input-lg input-white">
                    </div>
                </div>

                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Business Phone 4</label>
                        <input type="text" name="phone4" value="{{ $set->phone4 }}" class="form-control input-lg input-white">
                    </div>
                </div>
            </div>
            {{-- End of row  --}}
