...
@section('head')
    ...
    <script>
        ...
        var _module = <?php echo json_encode($module);?>;
    </script>
@endsection
...
@section('body')
    ...
    <section class="mt-20">
        <div class="container-fluid">
            ...
            {!! Form::model($module, ['method' => 'PATCH', 'route' => ['modules.update', $module->id], 'class' => 'form' ]) !!}
                        ...
                        <div class="block">
                            <div class="block-content">
                                ...
                                <div class="mt-40">
                                    ...
                                    <textarea name="excerpt" class="form-control no-resize" rows="3">{{ $module->excerpt }}</textarea>
                                </div>

                                <div class="mt-20">
                                    <label>Content</label>
                                    <textarea name="description" class="tiny">{{ $module->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="mt-20">
                            <button type="submit" class="btn btn-lg btn-blue">
                                <i class="flaticon-check mr-10"></i> Update Service
                            </button>
                        </div>
                    </div>
                    {{-- End of col 3 --}}
